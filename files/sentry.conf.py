...
LOGGING['handlers']['null'] = LOGGING['handlers']['console']
LOGGING['handlers']['internal'] = LOGGING['handlers']['console']
LOGGING['handlers']['metrics'] = LOGGING['handlers']['console']
LOGGING['handlers']['django_internal'] = LOGGING['handlers']['console']
...
if os.getenv('SENTRY_GCS_BUCKET_NAME', False):
    SENTRY_OPTIONS['filestore.backend'] = 'gcs'
    SENTRY_OPTIONS['filestore.options'] = {
        'bucket_name': os.getenv('SENTRY_GCS_BUCKET_NAME'),
    }
else:
